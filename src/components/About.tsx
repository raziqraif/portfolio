      ...
      <Container id={"about"} style={aboutStyle}>
        ...
        >
          ...
          <div className={"d-flex d-flex-row"}>
            <div style={textStyle}>
              I build scientific software and compilers. I primarily have experience designing analysis tools research efforts on sustainability problems. Currently, I am developing a framework to improve pointer analysis performance at Purdue RSSys Lab.
